...
class ATM_Error_Sync implements Runnable {
	...
	// 입금 
	// synconized 적용 : 메소드 실행시 동기화 처리
	// 하나의 스레드에서 메소드 사용하는 동안 실행을 보장
	// 다른 스레드에서 사용하려고 할 때 대기상태가 됨 (필드값에 대한 동기화 처리)
...
public class AMT_Thread_Error_Sync {
